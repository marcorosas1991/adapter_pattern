...
public class SocialMediaDemo implements Runnable {
    ...
    private void analyzeYouTubeVideos() {
        ...
        YouTubeAdapter video1 = new YouTubeAdapter(new YouTubeVideo("MormonMessages", "Bullying",
                "President Uchtdorf counsels us to stop bullying."));

        YouTubeAdapter video2 = new YouTubeAdapter(new YouTubeVideo("MormonMessages", "Patterns of Light",
                "Elder Bednar teaches about the Light of Christ."));

        YouTubeAdapter video3 = new YouTubeAdapter(new YouTubeVideo("Randy Pausch", "The Last Lecture",
